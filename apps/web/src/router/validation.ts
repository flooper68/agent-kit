/**
 * Route validation utilities for client-side navigation.
 *
 * Provides functions to validate paths against known routes before navigation,
 * preventing navigation to invalid/non-existent pages.
 */
