...
export function createUpdateAgentAction(context: UpdateAgentContext): Tool {
  return tool({
    description:
      "Update an agent's configuration. For server agents, you can update name, description, model settings, tools, and system prompt. External agents can only have their status changed via setAgentEnabled action.",
