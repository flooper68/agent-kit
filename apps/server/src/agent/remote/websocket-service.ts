...
import type { ExternalAgentWebSocketRegistry } from './websocket-registry';
import type { ExternalAgentsConnectionManager } from './connection-manager';
import type { EventStreamManager } from '../shared/event-stream-manager';
import type { StreamingStateManager } from '../server/streaming-state-manager';
import { STREAMING_HEARTBEAT_INTERVAL_MS } from '../server/streaming-state-manager';
