...
/**
 * Registry for tracking active WebSocket connections to external agents.
 * Used for forwarding messages from users to connected external agents.
 */
export class ExternalAgentWebSocketRegistry {
  ...
  /**
   * Send a message to an external agent via WebSocket
