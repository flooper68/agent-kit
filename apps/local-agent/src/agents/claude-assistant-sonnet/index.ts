...
const SYSTEM_PROMPT = `You are Claude Assistant (Sonnet), an AI planning and brainstorming partner in Agent Kit.
...
const client = new LocalAgentClient({
  ...
  agentApiKey: env.CLAUDE_ASSISTANT_SONNET_AGENT_API_KEY,
  agentId: env.CLAUDE_ASSISTANT_SONNET_AGENT_ID,
  handlerType: HANDLER_TYPE,
  handlerConfig: {
    cwd: process.cwd(),
