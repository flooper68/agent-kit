 ...
 *
 * Use this for page-level or container-level errors when the entire
 * chat cannot be shown (e.g., failed to load conversation).
 *
 * For inline runtime errors during conversation, use ErrorBanner instead.
 */
