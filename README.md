...
Run AI agents on your local machine with access to your file system and local tools.

**[Local Agents Documentation](./docs/local-agents.md)** - Complete guide covering architecture, setup, and usage
